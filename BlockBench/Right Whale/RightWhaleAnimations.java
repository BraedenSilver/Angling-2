...
public class RightWhaleAnimation {
	...
	public static final AnimationDefinition flop = AnimationDefinition.Builder.withLength(2.0F).looping()
		...
		.addAnimation("right_fin", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(13.759F, 10.5488F, 58.7121F), AnimationChannel.Interpolations.LINEAR)
		))
	...
	public static final AnimationDefinition swimming = AnimationDefinition.Builder.withLength(3.0F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
