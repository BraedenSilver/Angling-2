 ...
 */
public class AnglingWorldGenProvider extends FabricDynamicRegistryProvider {

    public AnglingWorldGenProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
