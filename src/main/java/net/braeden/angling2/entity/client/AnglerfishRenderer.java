...
import net.braeden.angling2.entity.AnglerfishEntity;
...
public class AnglerfishRenderer extends MobRenderer<AnglerfishEntity, AnglerfishRenderState, AnglerfishModel> {
    ...
    public AnglerfishRenderer(EntityRendererProvider.Context context) {
        super(context, new AnglerfishModel(context.bakeLayer(AnglingEntityModelLayers.ANGLERFISH)), 0.4F);
        this.addLayer(new AnglingEyesLayer<>(this, OVERLAY_TEXTURE));
    }
