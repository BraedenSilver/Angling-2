...
public class RoeBlockEntityRenderer implements BlockEntityRenderer<RoeBlockEntity, BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(RoeBlockEntity entity, BlockEntityRenderState state, float partialTick, Vec3 camera, ModelFeatureRenderer.CrumblingOverlay overlay) {
