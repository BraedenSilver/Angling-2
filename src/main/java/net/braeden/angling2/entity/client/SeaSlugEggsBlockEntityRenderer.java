...
public class SeaSlugEggsBlockEntityRenderer implements BlockEntityRenderer<SeaSlugEggsBlockEntity, BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(SeaSlugEggsBlockEntity entity, BlockEntityRenderState state, float partialTick, Vec3 camera, ModelFeatureRenderer.CrumblingOverlay overlay) {
