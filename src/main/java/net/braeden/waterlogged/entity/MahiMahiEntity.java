...
public class MahiMahiEntity extends AbstractFish implements WormBreeder {
    public final AnimationState idleAnimationState = new AnimationState();
    public final AnimationState flopAnimationState = new AnimationState();

    private int wormBredTimer = 0;

    public MahiMahiEntity(EntityType<? extends MahiMahiEntity> type, Level level) {
        super(type, level);
    }
    ...
    public net.minecraft.world.item.ItemStack getBucketItemStack() {
        return new net.minecraft.world.item.ItemStack(WaterloggedItems.MAHI_MAHI_BUCKET);
    }
