...
public final class AnglerfishAnimations {
    private AnglerfishAnimations() {}
    ...
    public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(1.5F)
        ...
        .addAnimation("illicium", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F,   KeyframeAnimations.degreeVec(45.0F,  10.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.75F,  KeyframeAnimations.degreeVec(45.0F, -10.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.5F,   KeyframeAnimations.degreeVec(45.0F,  10.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
        ))
    ...
    public static final AnimationDefinition FLOP = AnimationDefinition.Builder.withLength(0.5F)
        ...
        .addAnimation("root", new AnimationChannel(AnimationChannel.Targets.POSITION,
            ...
            new Keyframe(0.25F, KeyframeAnimations.posVec(20.0F, -20.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.5F,  KeyframeAnimations.posVec(20.0F, -20.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION,
